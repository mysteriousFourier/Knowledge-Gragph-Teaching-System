...
## chapter17_002 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Scales of Environmental Sensitivity
...
## chapter17_003 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Environmental vs. Genetic Canalization
...
## chapter17_004 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Evidence for Heritable Variation in the Environmental Variance
...
## chapter17_005 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / MODELING GENETIC VARIATION IN $ \sigma_{E}^{2} $

**[推导 Derivation]**

A variety of statistical models have been proposed to account for the heritable transmission of at least part of the environmental variance. The starting point for each model is that the phenotypic value of an individual of genotype i can be written as

> **Formula (17.1a)** · `17.1a` · source: `chapter17_block_017` · MODELING GENETIC VARIATION IN $ \sigma_{E}^{2} $
>
...
> **Formula (17.1b)** · `17.1b` · source: `chapter17_block_018` · MODELING GENETIC VARIATION IN $ \sigma_{E}^{2} $
>
...
## chapter17_006 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / The Multiplicative Model
...
> **Formula (17.2a)** · `17.2a` · source: `chapter17_block_020` · The Multiplicative Model
>
...
> **Formula (17.2b)** · `17.2b` · source: `chapter17_block_021` · The Multiplicative Model
>
...
> **Formula (17.2c)** · `17.2c` · source: `chapter17_block_021` · The Multiplicative Model
>
...
> **Formula (17.2d)** · `17.2d` · source: `chapter17_block_025` · The Multiplicative Model
>
...
## chapter17_007 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / The Exponential Model
...
> **Formula (17.3a)** · `17.3a` · source: `chapter17_block_027` · The Exponential Model
>
...
> **Table 17.1** · `17.1` · page 7 · source: `chapter17_007`
...
> **Formula (17.3b)** · `17.3b` · source: `chapter17_block_031` · The Exponential Model
>
...
> **Formula (17.3c)** · `17.3c` · source: `chapter17_block_032` · The Exponential Model
>
...
> **Formula (17.3d)** · `17.3d` · source: `chapter17_block_032` · The Exponential Model
>
> $$ \sigma_{E}^{2}=\sigma_{e}^{2}\exp\left(\mu_{A_{v}}+\sigma_{A_{v}}^{2}/2\right) $$


Equation 17.3d shows that either decreasing the mean breeding value, $ \mu_{A_v} $, or its additive variance, $ \sigma_{A_v} $, decreases the environmental variance. Comparison of Equations 17.2c and 17.3d shows one subtle difference between the multiplicative and exponential models. Under the former, the contribution to the environmental variance is a function of $ \mu_{A_v}^2 $, meaning that the minimal population environmental variance occurs when $ \mu_{A_v} = 0 $, and any deviation away from zero increases the average environmental variance. By contrast, under the exponential model, decreasing $ \mu_{A_v} $ always decreases the average value of $ \sigma_E^2 $ in the population. Thus, under the exponential model, $ \sigma_E^2 $ can be selected to be arbitrarily small, while under the multiplicative model, it has a lower bound set by $ \sigma_{A_v}^2 $ (and more generally, by the dominance variance as well; see Equation 17.2d).

---

## chapter17_008 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / The Additive Model
...
> **Formula (17.4a)** · `17.4a` · source: `chapter17_block_034` · The Additive Model
>
...
> **Formula (17.4b)** · `17.4b` · source: `chapter17_block_035` · The Additive Model
>
...
> **Formula (17.4c)** · `17.4c` · source: `chapter17_block_035` · The Additive Model
>
...
>
> Recalling that $ \mathrm{E}[x^{2}] = \mu_{x}^{2} + \sigma_{x}^{2} $ yields $$ \sigma_{E}^{2}=\sigma_{e}^{2}\mathrm{E}[\gamma^{2}]=\sigma_{e}^{2}\left(\sigma_{\gamma}^{2}+\mu_{\gamma}^{2}\right) $$
>
> Now consider the exponential model (Equation 17.3a). By construction, both E and e have expected values equal to zero, and the variances of E and e are simply the expected values of $ E^{2} $ and $ e^{2} $. Taking expectations $$ \sigma_{E}^{2}=\mathrm{E}\left[\left(e\cdot\exp\{A_{v}/2\}\right)^{2}\right]=\sigma_{e}^{2}\mathrm{E}\left[\left(\exp\{A_{v}/2\}\right)^{2}\right]=\sigma_{e}^{2}\mathrm{E}\left[\exp\left(A_{v}\right)\right] $$
>
...
## chapter17_009 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / The Heritability of the Environmental Variance, $ h_{v}^{2} $
...
> **Formula (17.5a)** · `17.5a` · source: `chapter17_block_044` · The Heritability of the Environmental Variance, $ h_{v}^{2} $
>
...
> **Formula (17.5b)** · `17.5b` · source: `chapter17_block_044` · The Heritability of the Environmental Variance, $ h_{v}^{2} $
>
...
> **Formula (17.5c)** · `17.5c` · source: `chapter17_block_045` · The Heritability of the Environmental Variance, $ h_{v}^{2} $
>
...
> **Table 17.2** · `17.2` · page 10 · source: `chapter17_009`
...
## chapter17_010 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / SELECTION ON $ \sigma_{E}^{2} $
...
## chapter17_011 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Translating the Response in $ A_{v} $ Into Response in $ \sigma_{E}^{2} $
...
> **Formula (17.6a)** · `17.6a` · source: `chapter17_block_055` · Translating the Response in $ A_{v} $ Into Response in $ \sigma_{E}^{2} $
>
...
The response is a bit more complex under the multiplicative and exponential models, as the mean population value, $ \sigma_{E}^{2} $, for the environmental variance is a nonlinear function of both the mean and the variance of $ A_{v} $ (Table 17.1). For the multiplicative model $$ \sigma_{E}^{2}=\left[\mu_{A_{v}}^{2}+\sigma^{2}(A_{v})\right]\sigma_{e}^{2} $$ Because the mean breeding value in generation $ t+1 $ can be expressed as the previous mean plus the response, $ \mu_{A_v}(t+1) = \mu_{A_v}(t) + R_{A_v}(t) $, if we assume that there is no change in the additive variance of environmental sensitivities following selection ($ \Delta\sigma^2(A_v) = 0 $), we have

> **Formula (17.6b)** · `17.6b` · source: `chapter17_block_056` · Translating the Response in $ A_{v} $ Into Response in $ \sigma_{E}^{2} $
>
...
> **Formula (17.6c)** · `17.6c` · source: `chapter17_block_058` · Translating the Response in $ A_{v} $ Into Response in $ \sigma_{E}^{2} $
>
...
## chapter17_012 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Response From Stabilizing Selection on Phenotypic Value, z
...
> **Formula (17.7a)** · `17.7a` · source: `chapter17_block_060` · Response From Stabilizing Selection on Phenotypic Value, z
>
> $$ W(z)=1-s(z-\theta)^{2} $$
...
> **Formula (17.7b)** · `17.7b` · source: `chapter17_block_060` · Response From Stabilizing Selection on Phenotypic Value, z
>
...
## chapter17_013 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Response From Directional Selection on z
...
> **Formula (17.9a)** · `17.9a` · source: `chapter17_block_065` · Response From Directional Selection on z
>
> $$ W(z)=1+sz $$
...
> **Formula (17.9b)** · `17.9b` · source: `chapter17_block_066` · Response From Directional Selection on z
>
...
> **Formula (17.10a)** · `17.10a` · source: `chapter17_block_068` · Response From Directional Selection on z
>
...
> **Formula (17.10b)** · `17.10b` · source: `chapter17_block_069` · Response From Directional Selection on z
>
...
## chapter17_014 · Short-term Changes in the Variance: 2. Changes in the Environmental Variance: Introduction / Response From Directional Selection on z
...
> **Formula (17.11)** · `17.11` · source: `chapter17_block_079` · Direct Selection on $ \sigma_{E}^{2} $ Using Repeated Records
>
...
> **Formula (17.12)** · `17.12` · source: `chapter17_block_081` · Direct Selection on $ \sigma_{E}^{2} $ Using Repeated Records
>
