...
class EquationPolicyTests(unittest.TestCase):
    ...
    def test_image_frame_layout_uses_orientation(self):
        ...
        self.assertIn("\\begin{frame}{Figure 25.1}", out_h)
        self.assertIn("\\safecontentimage{fig/图25_1.png}", out_h)
        self.assertIn("\\begin{frame}{Figure 25.2}", out_v)
        self.assertIn("\\safeverticalimage{fig/图25_2.png}", out_v)
