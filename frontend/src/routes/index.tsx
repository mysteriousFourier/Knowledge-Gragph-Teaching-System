...
import { BookOpen, Brain, GraduationCap, LogIn, Network, ShieldCheck } from "lucide-react"
  ...
  return (
    <section>
      ...
      <div className="route-grid">
        ...
        <RouteCard to="/teacher" icon={<BookOpen size={20} />} title="教师端" text="备课、授课、题库" />
      ...
      <div className="mt-8 grid gap-3 border-t pt-6">
        ...
        <WorkflowLine icon={<Brain size={17} />} title="Graph" text="导入 Markdown 知识图谱，生成授课文案。" />
